...
function verifySpeedLevelRunChecksum(json) {
  const {
    guid,
    addonVersion,
    wowVersion,
  ...
  const generatedChecksum = StringHash(
    guid +
      addonVersion +
      wowVersion +
      faction +
  ...
  return generatedChecksum === json.checksum;
}

module.exports = { verifySpeedLevelRunChecksum };
